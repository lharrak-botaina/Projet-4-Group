...
import Avenvement_group from "./Avencement_group";
    ...
    render(){
        return(
            <div>
               ...
               <Avenvement_group data={this.state.group_av} label={`${this.state.group_av}%`}/>
               {/* <Avenvement_group now={this.state.group_av}/> */}
                        </div> 
        );
    }
